...
public class ProductProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        mDbHelper = new InvertoryDbHelper(getContext());
        return true;
    }
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        String supplier_name = values.getAsString(ProductEntry.COLUMN_SUPPLIERS_NAME);
        if (supplier_name == null) {
            throw new IllegalArgumentException("Product requires a Supplier's name");
        }

        // Check that the suppliers number is not null
        String supplier_number = values.getAsString(ProductEntry.COLUMN_SUPPLIERS_CONTACT_NUMBER);
